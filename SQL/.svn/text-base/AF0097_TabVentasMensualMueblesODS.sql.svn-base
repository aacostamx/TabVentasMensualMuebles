-- =============================================
-- Procedimiento AF0097_TabVentasMensualMueblesODS
-- =============================================
use Carteras
go
if object_id ('Carteras.dbo.AF0097_TabVentasMensualMueblesODS ','P') is not null 
drop procedure  AF0097_TabVentasMensualMueblesODS
go
create procedure AF0097_TabVentasMensualMueblesODS
as
